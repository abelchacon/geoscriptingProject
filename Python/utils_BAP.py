...
"""
Set of functions that define the Best Available Pixel algorithm 


    Outline of functions:
        - calculates cloud mask from Sentinel 2 SCL band data
        - calculates cloud coverage score
        - calculates date score
        - creates rank mask
        - aggregates BAP scores
        - calculates day of month
        - calcualte date score
        - maximum score selector

"""



def calculate_cloud_mask(scl: openeo.DataCube):
    """
    Calculate cloud mask from SCL data.
    Args:
        scl: openeo datacube of SCL band
    Returns:
...
def create_rank_mask(score: openeo.DataCube):
    """
...
def aggregate_BAP_scores(dtc_score: openeo.DataCube,
                        ...
                        weights: Optional[List] = [1, 0.8, 0.5]):
    """
...
def day_of_month_calc(input: openeo.DataCube):
    """
...
def date_score_calc(day: openeo.DataCube):
    """
...
def max_score_selection(score: openeo.DataCube):
    """
